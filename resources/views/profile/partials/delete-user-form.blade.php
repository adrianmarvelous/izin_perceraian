<div class="card border-danger">
    <div class="card-header text-danger">
        ...
        <small class="text-muted">{{ __('Once your account is deleted, all of its resources and data will be permanently deleted.') }}</small>
    </div>
    <div class="card-body">
        ...
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmUserDeletionModal">
            <i class="bx bx-trash"></i> {{ __('Delete Account') }}
        </button>
