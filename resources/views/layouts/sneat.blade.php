...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Izin Perceraian</title>
    ...
    <link rel="stylesheet" href="{{ asset('templete/sneat/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
